        ...
        <div className="max-w-[1200px] mx-auto px-8 grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-20 items-center relative z-[2]">
          <div>
            ...
            >
              ...
              more energy, clarity, and control — now and for
              decades to come.
            </motion.p>
            ...
            <Reveal>
              <div>
                ...
                <p className="mb-5 text-[var(--light-gray)] leading-[1.8] text-lg">
                  ...
                  business success — it was what she saw behind
                  the scenes.
                </p>
          ...
          <Reveal>
            <div className="bg-gradient-to-br from-[var(--charcoal)] to-[var(--near-black)] p-[80px_60px] text-center border border-[rgba(255,0,128,0.2)] relative overflow-hidden">
              ...
              <p className="text-[1.3rem] text-[var(--off-white)] mb-12 relative z-[1]">
                ...
                until much later — one that quietly determines
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {[
              ...
              },
              {
                ...
                desc: "Moderate, evidence-based advice gets buried. What trends is usually what's most provocative — not most useful.",
              },
              {
                num: "03",
            ...
            {[
              {
                ...
                desc: "For understanding your health — beyond symptoms, beyond trends.",
              },
              {
                num: "02",
              ...
              },
              {
                ...
                desc: "Most people don't regain until much later — if they regain it at all.",
              },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 0.1}>
          ...
          <div className="mb-16">
            ...
            <Reveal>
              <p className="text-xl text-[rgba(255,255,255,0.9)] max-w-[800px] leading-[1.7]">
                ...
                community come together — so health doesn't
            ...
            {[
              {
                ...
                desc: "Why real change requires connection, accountability, and shared experience — not just information.",
              },
              {
              ...
              {
                title: "Real Support",
                desc: "What support actually looks like in practice — from expert-led guidance to peer-driven accountability.",
              },
            ].map((item, i) => (
              <Reveal key={i} delay={i * 0.1}>
          ...
          <Reveal>
            <div>
              ...
              <p className="text-xl text-[var(--light-gray)] max-w-[700px] mx-auto mb-14 leading-[1.7]">
                ...
                protect your health — while building everything
                else.
              </p>
              <button
                onClick={() => setIsModalOpen(true)}
